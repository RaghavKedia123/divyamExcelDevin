...
class BusinessIssueResolutionScreen extends StatefulWidget {
  const BusinessIssueResolutionScreen({
    super.key,
  ...
  @override
  State<BusinessIssueResolutionScreen> createState() =>
      _BusinessIssueResolutionScreenState();
}

class _BusinessIssueResolutionScreenState
    extends State<BusinessIssueResolutionScreen> {
  @override
