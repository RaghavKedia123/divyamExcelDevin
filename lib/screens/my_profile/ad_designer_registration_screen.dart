...
class AdDesignerRegistrationScreen extends StatefulWidget {
  const AdDesignerRegistrationScreen({
    super.key,
  ...
  @override
  State<AdDesignerRegistrationScreen> createState() =>
      _AdDesignerRegistrationScreenState();
}

class _AdDesignerRegistrationScreenState
    extends State<AdDesignerRegistrationScreen> {
  @override
          ...
          child: SingleChildScrollView(
            ...
            child: const Column(
              children: [
                ...
                SizedBox(height: 30),
                CustomSubmitButton(buttonText: 'Register as Ad Designer'),
              ],
            ),
          ),
        ),
