...
class FamousIssueResolutionScreen extends StatefulWidget {
  const FamousIssueResolutionScreen({
    super.key,
  ...
  @override
  State<FamousIssueResolutionScreen> createState() =>
      _FamousIssueResolutionScreenState();
}

class _FamousIssueResolutionScreenState
    extends State<FamousIssueResolutionScreen> {
  @override
            ...
            child: const Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: NeuButtonPrimary(label: 'Edit famous'),
                    ),
                    SizedBox(width: 20),
                    Expanded(
                      child: NeuButtonPrimary(label: 'Raise a ticket'),
                    ),
                  ],
                ),
                SizedBox(height: 30),
