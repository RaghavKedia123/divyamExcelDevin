...
class NewspaperIssueResolutionScreen extends StatefulWidget {
  const NewspaperIssueResolutionScreen({
    super.key,
  ...
  @override
  State<NewspaperIssueResolutionScreen> createState() =>
      _NewspaperIssueResolutionScreenState();
}

class _NewspaperIssueResolutionScreenState
    extends State<NewspaperIssueResolutionScreen> {
  @override
          ...
          child: SingleChildScrollView(
            ...
            child: const Column(
              ...
              children: [
                ...
                BodyBoldRegularText(
                  boldText: 'Reason: ',
                  regularText: 'Violation of terms & conditions',
                ),
                SizedBox(height: 10),
                BodyBoldRegularText(
                ...
                Row(
                  ...
                  children: [
                    NeuButtonPrimary(label: 'Edit newspaper'),
                    NeuButtonPrimary(label: 'Raise a ticket'),
                  ],
                ),
                SizedBox(height: 30),
                Center(
