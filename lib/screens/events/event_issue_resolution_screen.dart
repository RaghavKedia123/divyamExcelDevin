...
class EventIssueResolutionScreen extends StatefulWidget {
  const EventIssueResolutionScreen({
    super.key,
  ...
  @override
  State<EventIssueResolutionScreen> createState() =>
      _EventIssueResolutionScreenState();
}

class _EventIssueResolutionScreenState
    extends State<EventIssueResolutionScreen> {
  @override
